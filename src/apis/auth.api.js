...
class AuthApi {
  static registerAccount = (body) => http.post('/auth/register', body)
  static loginAccount = (body) => http.post('/auth/login', body)
  static logoutAccount = () =>
    http.post('/auth/signout', {
      refreshToken: Auth.getTokenFromLs().refresh_token
    })
  static updateProfile = (body) => http.patch('/auth/profile', body)
  static changePassword = (body) => http.patch('/auth/password', body)
